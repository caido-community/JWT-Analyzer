<template>
  <div class="h-full flex flex-col gap-1">
        ...
        <div class="p-4 flex justify-between items-center gap-4 flex-wrap">
          ...
          <div class="flex items-center gap-2 flex-1 max-w-3xl">
            <div class="relative flex-1">
              ...
              <i
                v-if="manualToken"
                class="fas fa-times absolute right-3 top-1/2 -translate-y-1/2 text-surface-400 text-xs cursor-pointer hover:text-surface-200"
                @click="manualToken = ''"
              />
            </div>
            <Button
    ...
    <div
      v-if="decodedTokens.length > 0 && activeToken !== undefined"
        ...
        <template #content>
          <div class="flex-1 overflow-auto p-4 flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-2">
                <div class="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    @click="copyJson(activeToken.header, 'Header')"
                  />
                </div>
                <JsonEditor
                  :model-value="JSON.stringify(activeToken.header, null, 2)"
                  readonly
                  min-height="220px"
                  max-height="220px"
                />
              ...
              <div class="flex flex-col gap-2">
                <div class="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    @click="copyJson(activeToken.payload, 'Payload')"
                  />
                </div>
                <JsonEditor
                  :model-value="JSON.stringify(activeToken.payload, null, 2)"
                  readonly
                  min-height="220px"
                  max-height="220px"
                />
            ...
            <div class="flex flex-col gap-3">
              <div class="flex items-center gap-2">
                <i class="fas fa-shield-halved text-surface-400"></i>
                <span class="text-sm font-medium text-surface-200"
    ...
    >
      <i class="fas fa-lock-open text-5xl"></i>
...
function onViewDetails(token: DecodedToken): void {
  viewTokenDetails(token, emit);
}

function onSendToEditor(token: DecodedToken): void {
